        ...
        public override void CompPostTick(ref float severityAdjustment)
        {
            if (Pawn.pather.Moving)
            {
                ...
                if (Props.fadingHediffs || Props.fadingNotMovingHediff)
                {
                    ...
                    else EBSGUtilities.FadingHediffs(Pawn, Props.notMovingSeverityPerHour / 2500 * -1, Props.hediffWhileNotMoving, Props.hediffsWhileNotMoving);
                }
            ...
            else
            {
                ...
                if (Props.fadingHediffs || Props.fadingMovingHediff)
                {
                    ...
                    else EBSGUtilities.FadingHediffs(Pawn, Props.movingSeverityPerHour / 2500 * -1, Props.hediffWhileMoving, Props.hediffsWhileMoving);
                }
